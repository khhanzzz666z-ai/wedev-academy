          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <input
                ...
                className={`w-full p-3 rounded-lg bg-white/3 border border-white/6 text-white placeholder-slate-500 focus:border-indigo-500 focus:outline-none transition`}
              />
            </div>
